...
var FillRateHelper = class {
  ...
  activate() {
    if (this._enabled && this._samplesStartTime == null) {
      ...
      this._samplesStartTime = window.performance.now();
    }
  }
  deactivateAndFlush() {
    if (!this._enabled) {
    ...
    var total_time_spent = window.performance.now() - start;
...
var NativeAnimatedModule = Platform_default2.OS === "ios" && window.RN$Bridgeless === true ? NativeAnimatedTurboModule_default : NativeAnimatedModule_default;
